    ...
    <view class="records" v-if="current == 1">
      ...
      >
        <view class="top">
          ...
          <view class="top-right">
            <view class="top-right-no">翻新单号：{{ item.mid }}</view>
            <view class="top-right-date"
              >翻新日期{{ item.maintenanceDate }}</view
            >
          </view>
        </view>
        <view class="bottom">
          <view class="bottom-item">
            <view class="bottom-label">翻新人</view>
            <view class="bottom-value">{{ item.updateBy }}</view>
          </view>
          <view class="bottom-item">
            <view class="bottom-label">翻新单位</view>
